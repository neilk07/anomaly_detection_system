...
if __name__ == "__main__":
    ...
    try:
        df_normal_train = pd.read_csv(NORMAL_DATA_PATH, index_col=0, parse_dates=True)
    ...
    try:
        df_anomalous_test = pd.read_csv(ANOMALOUS_DATA_PATH, index_col=0, parse_dates=True)
